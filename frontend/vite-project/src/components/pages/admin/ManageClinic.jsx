...
const ManageClinic = () => {
  ...
  const handleCreateClinic = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Không thể tạo phòng khám');
  ...
  const handleUpdateClinic = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Không thể cập nhật phòng khám');
  ...
  const handleImagesEditUpload = (e) => {
    e.preventDefault();
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-600 mt-2">
                  Quản lý thông tin các phòng khám trong hệ thống
                </p>
              </div>
              <button
                onClick={() => {
  ...
  if (view === 'detail' && selectedClinic) {
    const images = selectedClinic.images
