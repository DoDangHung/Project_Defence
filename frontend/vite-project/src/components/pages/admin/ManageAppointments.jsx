        ...
        <div class="w-full max-w-7xl mx-auto px-6 lg:px-8 overflow-x-auto">
          <div class="flex flex-col md:flex-row max-md:gap-3 items-center justify-between mb-5">
            ...
            <div class="flex items-center gap-px rounded-lg bg-gray-100 p-1">
              <button class="rounded-lg py-2.5 px-5 text-sm font-medium text-gray-500 transition-all duration-300 hover:bg-white hover:text-indigo-600">
                Day
              </button>
              <button class="rounded-lg py-2.5 px-5 text-sm font-medium text-indigo-600 bg-white transition-all duration-300 hover:bg-white hover:text-indigo-600">
                Week
              </button>
              <button class="rounded-lg py-2.5 px-5 text-sm font-medium text-gray-500 transition-all duration-300 hover:bg-white hover:text-indigo-600">
                Month
          ...
          <div class=" relative">
            <div class="grid grid-cols-7 border-t border-gray-200 sticky top-0 left-0 w-full">
              ...
              <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-indigo-600">
                Jan 9
              </div>
              <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-gray-900">
                Jan 10
